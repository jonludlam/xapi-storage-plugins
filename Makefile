...
LIBS_FILES+=util.py log.py VhdMetabase.py vhdutil.py
...
install:
	...
	(cd volume/org.xen.xapi.storage.ffs; install -m 0755 plugin.py sr.py volume.py ffs.py $(DESTDIR)$(SCRIPTDIR)/volume/org.xen.xapi.storage.ffs)
